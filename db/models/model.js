...
User.sync({force: true})
  .then(() => {
    ...
    return User.bulkCreate([
            {id: '9',firstname: 'alice', email: 'asdf23@gmail.com', profilepic: 'https://images.pexels.com/photos/355018/pexels-photo-355018.jpeg?h=350&auto=compress&cs=tinysrgb', images: [], bio: 'I am a big dummy user', gender: 'female', age: 22, latitude: -117.9854168, longitude: 33.9246179},
            {id: '10',firstname: 'chanel', email: 'asd34f@gmail.com', profilepic: 'https://images.pexels.com/photos/40503/woman-snow-winter-portrait-40503.jpeg?h=350&auto=compress&cs=tinysrgb', images: [], bio: 'I am a big dummy user', gender: 'female', age: 23, latitude: -117.9854168, longitude: 33.9246179},
            {id: '11',firstname: 'karen', email: 'asd45f@gmail.com', profilepic: 'https://images.pexels.com/photos/47346/portrait-blond-blondie-brunette-47346.jpeg?h=350&auto=compress&cs=tinysrgb', images: [], bio: 'I am a big dummy user', gender: 'female', age: 24, latitude: -117.9854168, longitude: 33.9246179},
            {id: '12',firstname: 'jessica', email: 'as34df@gmail.com', profilepic: 'https://images.pexels.com/photos/220420/pexels-photo-220420.jpeg?h=350&auto=compress&cs=tinysrgb', images: [], bio: 'I am a big dummy user', gender: 'female', age: 25, latitude: -117.9854168, longitude: 33.9246179},
            ...
            {id: '20',firstname: 'liz', email: 'tas34df@gmail.com', profilepic: 'https://lh4.googleusercontent.com/-bAuprXS-mNs/TXeEEvjmx5I/AAAAAAAAA0E/rSszayLgyII/s1600/Screen+shot+2011-03-08+at+6.14.39+AM.png', images: [], bio: 'I am a big dummy user', gender: 'female', age: 25, longitude: 117.9242, latitude: 33.8704},
            {id: '21',firstname: 'alex', email: 'aus345df@gmail.com', profilepic: 'http://clickzoom.net/uploads/reasons-every-man-should-date-a-latina-at-least-once-in-his-life-06.jpg', images: [], bio: 'I am a big dummy user', gender: 'female', age: 26, longitude: 119.9242, latitude: 33.8704},
